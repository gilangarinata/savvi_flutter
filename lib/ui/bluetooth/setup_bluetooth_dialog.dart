...
class _SetupBluetoothDialogState extends State<SetupBluetoothDialog> {
  ...
  TextEditingController _hardwareIdSebelum = new TextEditingController();
  TextEditingController _hardwareIdSesudah = new TextEditingController();
                      ...
                      children: <Widget>[
                              ...
                              children: <Widget>[
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText: "SSID",
                                    labelStyle:
                                        MyFieldStyle.myFieldLabelStylePrimary(),
                                    enabledBorder:
                                        MyFieldStyle.myUnderlineFieldStyle(),
                                    focusedBorder: MyFieldStyle
                                        .myUnderlineFocusFieldStyle(),
                                  ),
                                ),
                                TextFormField(
                        ...
                        Align(
                          ...
                          child: FlatButton(
                            ...
                            color: MyColors.primary,
                            onPressed: () {
                              String value = _ssidController.text +
                                  ":" +
                                  ...
                                  _time +
                                  ":" +
                                  _hardwareIdSebelum.text +
                                  ":" +
                                  _hardwareIdSesudah.text +
                                  ":" +
                                  (isChecked ? "1" : "0");
